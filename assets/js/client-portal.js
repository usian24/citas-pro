...
function loadBizDirect(bizId) {
  ...
  if (biz.insta) {
    // Limpia: http, https, www, instagram.com, arrobas y barras iniciales
  ...
  if (biz.facebook) {
    // Limpia: http, https, www, facebook.com y barras iniciales
  ...
  if (biz.x_url) {
    // Limpia: http, https, www, x.com, twitter.com, arrobas y barras iniciales
